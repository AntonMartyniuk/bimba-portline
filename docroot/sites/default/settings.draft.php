...
$config['portline_integration']['portline_session_init_url'] = 'https://dev.portline.com/bimba/api/sso.cfm';
$config['portline_integration']['portline_cart_url'] = 'https://dev.portline.com/bimba/api/cart.cfm';
$config['portline_integration']['portline_cart_iframe'] = 'https://dev.portline.com/bimba/cart.cfm';
$config['portline_integration']['portline_cart_price_and_delivery'] = 'https://bimbanet.com/mrcjava/servlet/BIMBANET.M00700s';
